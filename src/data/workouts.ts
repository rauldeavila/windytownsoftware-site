...
export const workouts: WorkoutDay[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { label: "E", content: "EMOM 10’\n1- 12/10 cal bike\n2- 10 power snatchs TNG (unbroaken)\n3- 12/10 cal bike\n4- 8 power snatchs TNG (unbroaken)\n5- 12/10 cal bike\n6- 6 power snatchs TNG unbroaken\n7- 12/10 cal bike\n8- 4 power snatchs TNG unbroaken\n9- 12/10 cal bike\n10- 2 power snatchs TNG unbroaken\n*progressão de carga livre" },
    ],
  },
  {
    date: "2025-08-14",
