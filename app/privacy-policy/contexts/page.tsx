...
export default function ContextsPrivacyPolicy() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      <h1 className="text-3xl font-bold mb-6">Privacy Policy - Contexts App</h1>

      <div className="prose prose-lg">
        <p>
          I, Raul de Avila Junior, built the Contexts app as a Freemium app. This SERVICE is provided by me at no cost and is intended for use as is.
        </p>
        ...
        <p>
          The terms used in this Privacy Policy have the same meanings as in my Terms and Conditions, which are accessible at Contexts unless otherwise defined in this Privacy Policy.
        </p>
        ...
        <p>
          I do not knowingly collect personally identifiable information from children. I encourage all children to never submit any personally identifiable information through the Application and/or Services. I encourage parents and legal guardians to monitor their children's Internet usage and to help enforce this Policy by instructing their children never to provide personally identifiable information through the Application and/or Services without their permission. If you have reason to believe that a child has provided personally identifiable information to me through the Application and/or Services, please contact me. You must also be at least 16 years of age to consent to the processing of your personally identifiable information in your country (in some countries I may allow your parent or guardian to do so on your behalf).
        </p>
        ...
        <p>
          This policy is effective as of 2025-03-20
        </p>

        <h2 className="text-2xl font-bold mt-8 mb-4">Contact Me</h2>

        <p>
          If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at windytownsoftware@gmail.com.
        </p>
      </div>
    </div>
  );
